  ...
  void _showDeleteConfirmationDialog(Map<String, dynamic> logement) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Confirmer la suppression du logement'),
          content: Text(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                try {
                  await ApiService.deleteLogement({'id': logement['id']});
                  ...
                  // Afficher un message d'erreur AVANT de fermer le dialog
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Erreur: ${e.toString()}'),
                      backgroundColor: Colors.red,
